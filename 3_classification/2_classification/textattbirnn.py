...
ck_callback = ModelCheckpoint('./checkpoints/textattbirnn/weights.{epoch:02d}-{val_f1:.4f}.hdf5',
                              monitor='val_f1',
                              mode='max', verbose=2,
                              save_best_only=True,
                              save_weights_only=True)
tb_callback = TensorBoard(log_dir='./logs/textattbirnn')
...
model_name = 'textattbirnn-model-' + JOB_NAME + '.best'
model_dir = os.path.join(base_dir, 'models', 'textattbirnn', model_name)
